                ...
                try
                {
                    ...
                    using (MySqlConnection con = new MySqlConnection(connectionString))
                    {
                        ...
                        using (MySqlCommand userCmd = new MySqlCommand(userQuery, con))
                        {
                            ...
                            string teacherQuery = "UPDATE teacher_info SET firstname = @FirstName, lastname = @LastName, email = @Email, age = @Age, gender = @Gender, birthday = @Birthday, contact = @Contact, profileimage = @ProfileImage, status = @Status WHERE username = @Username";
                            using (MySqlCommand teacherCmd = new MySqlCommand(teacherQuery, con))
                            {
                                ...
                                teacherCmd.Parameters.AddWithValue("@Age", teacherage);
                                ...
                                teacherCmd.Parameters.AddWithValue("@Status", status); // Fix this line, it should be for teacherCmd, not userCmd
                                ...
                                {
                                    ShowErrorMessage("Error updating teacher information or user information");
                                }
                            }
                        }
                    }
