                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <div class="materials-box">
                                                            <div class="materials-title"><%# Eval("materialsname") %></div>
                                                            <div class="materials-teacher"><%# Eval("instructions") %></div>
                                                            <div class="materials-date"><%# Eval("posttype") %></div>
                                                            <div class="materials-content"><%# Eval("points") %></div>
                                                            <div class="materials-content"><%# Eval("duedate") %></div>
